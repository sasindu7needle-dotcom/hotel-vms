...
<body class="landing-page visitor-registration-page">
    <main class="registration-shell payment-status-shell">
        ...
        <section class="registration-card payment-status-card">
            ...
            <h1 class="headline">Pay at the counter<span class="dot">.</span></h1>
            ...
            <div class="payment-amount"><span>Cash amount due</span><strong>{{ $details['entrance_fee'] !== null ? 'LKR '.number_format((float) $details['entrance_fee'], 2) : 'Not assigned' }}</strong></div>
